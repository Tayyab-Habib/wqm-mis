...
class UpdateTestRequest extends FormRequest
{
    ...
    {
        return auth()->user()->can('edit_tests');
    }
    ...
    public function rules()
    {
        return [
            ...
            'water_quality_parameter' => ['required', 'unique:tests,water_quality_parameter,' . $this->test->id, 'max:255'],
            'unit' => ['required', 'max:255'],
            'detectable_limit' => ['required', 'numeric', 'decimal:2,2'],
